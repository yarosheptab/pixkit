...
const KEY = "pixkit-cookie-consent"
...
export function CookieConsent() {
  ...
  return (
    <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 100, padding: "14px 24px", background: "var(--surface)", borderTop: "1px solid var(--border)" }}>
